    ...
    public partial class frmKategori : Form
    {
        ...
        public void KategoriListele()
        {
            try
            {
                ...
                {
                    using (SqlDataAdapter adapter = new SqlDataAdapter("select * from Kategoriler", connection))
                    {
                        adapter.Fill(dt);
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                using (SqlCommand cmd = new SqlCommand("INSERT INTO Kategoriler (Kategori) VALUES (@p1)", connection))
                {
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                using (SqlCommand sqlCommand = new SqlCommand("delete from kategoriler where kategori = @p1", connection))
                {
        ...
        private void btnGüncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                using (SqlCommand sqlCommand = new SqlCommand("update kategoriler set kategori = @p1 where kategoriId = @p2", connection))
                {
                    sqlCommand.Parameters.AddWithValue("@p1", txtKategori.Text);
        ...
        private void btnAra_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                using (SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Kategoriler WHERE Kategori LIKE @p1", connection))
                {
